module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
        ...
        build: {
          files: {
          'scripts/site.min.js': ['_scripts/libs/jquery-1.12.4.js', '_scripts/libs/bootstrap-3.3.7.js', '_scripts/libs/bootstrap-accessibility-1.0.3.js', '_scripts/components/footer.js', '_scripts/components/verslag-schrijven.js', '_scripts/components/verslag.js', '_scripts/components/snelschaak.js', '_scripts/components/tussenstand.js'],
