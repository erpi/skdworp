...
title: "Dworp legt concurrentie over de knie"
...
stelling_uitleg: 
stelling_oplossing: 
description: "In deze negende ronde gingen we op bezoek bij het nog in puntennood verkerende Wetteren."
image:
  path: assets/images/fb/fb_post_23.jpg
draft: false
noindex: false
pgn_viewer: true
---
...
<div id="board1"></div>
<script>config = {pgn: '1... Nxd4 2. Nxd4 Bxc5 3. Be3 Bxd4 4. Bxd4 Be6 5. Qg3', position: 'r1bq1rk1/ppp1bppp/2n5/2PN4/3P4/1Q3N2/PP3PPP/R1B1K2R b KQ - 0 1', showCoords: false, pieceStyle: 'merida', locale: 'nl', layout: 'left', coordsInner: false, headers: false, hideMovesBefore: true, notation: 'short', notationLayout: 'inline', };PGNV.pgnView('board1', config);</script>
...
<div id="board2"></div>
<script>config = {pgn: '25. Nb6 Qd4+ 26. Be3 Re8 27. Bxd4 Rxe1+ 28. Rxe1 cxd4', position: 'r4k1r/pp3p2/5P2/1Ppq3p/2N2Bb1/8/6PP/R3Q1K1 w - - 0 25', showCoords: false, pieceStyle: 'merida', locale: 'nl', layout: 'left', coordsInner: false, headers: false, hideMovesBefore: true, notation: 'short', notationLayout: 'inline', orientation: 'black',};PGNV.pgnView('board2', config);</script>
...
## Nieuwe regels, enkele bedenkingen

Het einde van het seizoen nadert stilaan en dus evalueerde Tom de interclubregels die dit jaar werden ingevoerd:

1. Wisselen van bordvolgorde. Ja dat is goed. Het maakt het interessant en verrassend. Om het de teamcaptains en de boekhouders makkelijker te maken, zou ik de beperking erop laten vallen. De speler van bord één mag op zes spelen en omgekeerd. Er is wel een goed systeem nodig om de opstellingen vooraf uit te wisselen.

2. Toewijzen van X aantal vaste spelers (titularissen) aan een ploeg. Ja ook goed, in combinatie met de regel dat een niet-titularis maar maximaal Y Elo mag hebben voor een reeks.

3. Om competitievervalsing te verminderen zou het goed zijn dat wie tijdens een seizoen al driemaal in een afdeling speelde niet meer in een lagere afdeling mag meedoen. Algemene forfaits van teams vallen doorgaans in de tweede seizoenshelft. Heel wat ploegen zijn dan al gered. Om te vermijden dat spelers van al geredde ploegen een handje gaan helpen in een lagere afdeling kan een ‘driemaal’ regel helpen.

[foto 1]: {{ "/assets/images/fb/fb_post_23.jpg" | absolute_url }}